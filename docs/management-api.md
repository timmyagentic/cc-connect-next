# cc-connect-next Management API Specification
...
The cc-connect-next Management API is an HTTP-based REST API that enables external applications (web dashboards, TUI clients, GUI desktop apps, Mac tray apps) to manage and monitor cc-connect-next instances. It complements the existing internal Unix socket API by providing a network-accessible, token-authenticated interface suitable for remote and local management tools.

### 1.1 Architecture

```
┌─────────────────────────────────────────────────────────────────────────┐
│                         cc-connect-next Process                               │
│                                                                          │
│  ┌──────────────────┐    ┌──────────────────┐    ┌──────────────────┐  │
...
|-----------------------|----------|--------------------------------------------------|
| `version`             | string   | cc-connect-next version (e.g. `v1.2.0`)              |
...
```json
{
  "ok": true,
  "data": {
    "data_dir": "/home/user/.cc-connect-next",
    "language": "en",
    "projects": [
      {
        "name": "my-backend",
    ...
    "entries": [
      {
        ...
        "attrs": {"socket": "/home/user/.cc-connect-next/run/api.sock"}
      }
    ]
  }
}
