...
card carries a dim "model · effort" footer line — model name and reasoning
effort only, never tokens, context, or paths.
...
"model · effort" footer generated by cc-connect-next itself.
